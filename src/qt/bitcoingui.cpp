                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("xbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About xbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about xbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for xbit"));
    ...
    openAction->setStatusTip(tr("Open a xbit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the xbit Core help message to get a list with possible xbit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("xbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xbit network", "", count));
}
...
{
    QString strTitle = tr("xbit Core"); // default title
