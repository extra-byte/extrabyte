...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* xbit features */
        {"xbit", "masternode", &masternode, true, true, false},
        {"xbit", "masternodelist", &masternodelist, true, true, false},
        {"xbit", "mnbudget", &mnbudget, true, true, false},
        {"xbit", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xbit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xbit", "mnsync", &mnsync, true, true, false},
        {"xbit", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xbit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xbitd, or the -server option to xbit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
