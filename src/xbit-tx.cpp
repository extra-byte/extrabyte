...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("xbit Core xbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xbit transaction") + "\n" +
                               "  xbit-tx [options] -create [commands]   " + _("Create hex-encoded xbit transaction") + "\n" +
                               "\n";
