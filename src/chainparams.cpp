...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 43101;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // xbit starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // xbit: 1 day
        nTargetSpacing = 1 * 300;  // xbit: 5 Min 
        nLastPOWBlock = 2016;   //Last Pow Block
        nMaturity = 10;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 615800;
        nMaxMoneyOut = 210000000 * COIN;

        const char* pszTimestamp = "xbit Core will create the biggest masternode network";
	...
	txNew.vout[0].scriptPubKey = CScript() << ParseHex("0486bce1bac0d543f104cbff2bd23680056a3b9ea05e1137d2ff90eeb5e08472eb500322593a2cb06fbf8297d7beb6cd30cb90f98153b5b7cce1493749e41e0284") << OP_CHECKSIG;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1552441254;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 120195;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xaf9f30b21fc092a7f53cfe2bbc9ab647208b869782ee1bdae6ab081ba69ab1dd"));
	    ...
	    vSeeds.push_back(CDNSSeedData("157.230.223.81", "157.230.223.81"));     // United States Seed
		vSeeds.push_back(CDNSSeedData("157.230.177.23", "157.230.177.23"));     // United States Seed
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // xbit: 1 day
        nTargetSpacing = 1 * 60;  // xbit: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 189); // Testnet xbit addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 41);  // Testnet xbit script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 219);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet xbit BIP32 pubkeys 
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x61)(0x60)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet xbit BIP32 prvkeys 
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // xbit: 1 day
        nTargetSpacing = 1 * 60;        // xbit: 1 minutes
