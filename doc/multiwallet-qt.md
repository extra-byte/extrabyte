...
In order to support loading of multiple wallets in xbit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xbit.cpp.
...
Changes to xbit.cpp
----------------------
xbit.cpp is the entry point into xbit-qt, and as such, will require some minor modifications to provide hooks for
