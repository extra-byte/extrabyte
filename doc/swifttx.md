...
This mechanism has been integrated into Bitcore-Node-xbit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xbit-Project/insight-api-xbit#web-socket-api](https://github.com/xbit-Project/insight-api-xbit#web-socket-api) 
* API: [https://github.com/xbit-Project/insight-api-xbit#swifttx-transactions](https://github.com/xbit-Project/insight-api-xbit#swifttx-transactions) 
...
By default, the xbit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the xbit Core daemon:
