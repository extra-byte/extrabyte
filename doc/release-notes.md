xbit Core version 2.3.0 is now available from:

  <https://github.com/xbit-project/xbit/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/xbit-project/xbit/issues>
...
[
  {
    ...
    winner: {
        address: addr,    (string) xbit MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode xbit address
...
xbit Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for xbit (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with xbit (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/xbit-project-translations/).
