...
RESOURCES += src/qt/xbit.qrc src/qt/xbit_locale.qrc

TRANSLATIONS += src/qt/locale/xbit_bg.ts \
                src/qt/locale/xbit_de.ts \
                src/qt/locale/xbit_en.ts \
                src/qt/locale/xbit_es.ts \
                src/qt/locale/xbit_fi.ts \
                src/qt/locale/xbit_fr.ts \
                src/qt/locale/xbit_it.ts \
                src/qt/locale/xbit_ja.ts \
                src/qt/locale/xbit_pl.ts \
                src/qt/locale/xbit_pt.ts \
                src/qt/locale/xbit_ru.ts \
                src/qt/locale/xbit_sk.ts \
                src/qt/locale/xbit_sv.ts \
                src/qt/locale/xbit_vi.ts \
                src/qt/locale/xbit_zh_CN.ts \
                src/qt/locale/xbit_zh_TW.ts
